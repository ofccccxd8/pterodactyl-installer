...
# download URLs
export PANEL_DL_URL="https://github.com/ofccccxd8/panelwonitoxwkqk/releases/latest/download/panel.tar.gz"
...
export GITHUB_BASE_URL=${GITHUB_BASE_URL:-"https://raw.githubusercontent.com/ofccccxd8/pterodactyl-installer"}
